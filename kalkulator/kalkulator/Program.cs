...
namespace kalkulator
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Perulangan do-wile akan menjalankan blok kode setidaknya satu kali 
            ...
            do
            {
                ...
                // .Tolong() membuat input menjadi huruf kecil, jadi 'Y' atau 'y' akan sama
        ...
        {
            Console.WriteLine("Pilihan operasi matematika : ");
        ...
        static bool AmbilInputAngka(out double angka1,out double angka2)
        {
            ...
            // Jika berhasil, return true dan nilainnya disimpan di variabel 'angka1'
            ...
            if (!double.TryParse(Console.ReadLine(), out angka1))
            {
                ...
                angka2 = 0; // Beri nilai default agar tida error
                return false;
            }
